...
📂 Power Query Editor – For ETL, cleaning and data transformation.
🧠 DAX (Data Analysis Expressions) – For advanced calculations, KPIs and forecasting logic.
...
To provide interactive, actionable analytics and reliable sales forecasts for improved planning, marketing, and profitability.

Walkthrough of Key Visuals:

Top KPIs:
Total Sales, Total Quantity, Total Profit, Avg. Delivery Time, Sales/Profit by State, City, Segment, Category

Sales & Profit by Month:
Dual-year comparison for trend analysis.

Sales by Payment & Ship Mode:
Breakdown by COD, Online, Card, and by delivery options.

Sales by Segment & Category:
Segment filter and bar charts for product/business insight.

Sales Forecasting:
Future trend projection using historical sales data (with confidence bands).
Helps set revenue targets and anticipate demand fluctuations.

Interactive Filters:
Drilldown by region, state, city, segment or time for in-depth exploration.

Business Impact & Insights:
Improved Decision-Making: Identify high-performing products, profitable regions and peak months.

Strategic Planning: Plan promotions for festivals and holidays based on occasion-wise spikes.

Targeted Marketing: Insights to launch targeted campaigns in top-performing and emerging markets.
...
6. Screenshots 
Dashboard Example:
<img width="1326" height="744" alt="Super Store Sales Dashboard" src="https://github.com/user-attachments/assets/60be6cb7-e455-4234-a4e1-f2df7f0ca000" />
<img width="1314" height="735" alt="Sales Forcasting" src="https://github.com/user-attachments/assets/bd0b2250-4e61-4860-b6f4-ec88abc5bd01" />
